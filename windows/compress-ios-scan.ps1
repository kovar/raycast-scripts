...
# @raycast.argument1 { "type": "dropdown", "placeholder": "Quality", "data": [{"title": "Small - JPEG 200 dpi, scanner-like (default)", "value": "small"}, {"title": "Lossless - PNG, no quality loss", "value": "lossless"}, {"title": "HQ - JPEG 300 dpi", "value": "hq"}, {"title": "Balanced - JPEG 250 dpi", "value": "balanced"}, {"title": "Tiny - JPEG 150 dpi", "value": "tiny"}] }
